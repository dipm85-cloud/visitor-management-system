...
| Branding | Application Settings with legacy fallback | Application Settings -> Branding | Partially migrated | Medium | OHP-017C | Application Settings owns branding values; legacy branding remains fallback during rollout. |
