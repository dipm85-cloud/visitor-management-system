...
| Shared Terminal | Application Settings plus Shared Terminals device administration | Application Settings -> Shared Terminal | Partially migrated | Medium | OHP-017C | Application Settings owns terminal display/reset settings; device registration remains in the existing Shared Terminals panel. |
...
| Future LMT | Not available | Application Settings -> Modules -> Future LMT | Future | Low | Future | Reserved only; no runtime behaviour in OHP-017C. |
