...
Application Settings controls how the application behaves: branding, product identity, visitor behaviour defaults, Shared Terminal behaviour, session security, notification defaults, privacy guardrails, Form Configuration, module availability, and module behaviour settings.
...
| Visitors | Application Settings plus Visitors workspace | Application Settings | Partially migrated setting | Visitor behaviour defaults and Visitor Walk-in/Planned Visit requirements are surfaced through Form Configuration. Visitor reason codes/dropdowns belong in Reference / Configuration Data when implemented. Visits remain operational data. |
...
| Form Configuration | Application Settings | Application Settings | Partially migrated setting | Form Configuration owns configurable Form Requirements for Assignments, Visitor Walk-ins, Planned Visits and future forms. Backend area codes remain work_assignments, visitor_walk_ins and planned_visits. |
| People & Assignments | People/Assignments workspaces | People & Assignments module | Business module | People & Assignments remains the business area for people records and assignments. Departments, contracts, sites, employers and work-time context are Reference / Configuration Data. Assignments are operational data. |
